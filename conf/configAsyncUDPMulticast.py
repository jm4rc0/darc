...
if len(prefix)==0:#
    asyncNames=None#numpy.zeros((5,),"c")
    #asyncNames[0]='1'
    #asyncNames[2:4]='11'
    ...
    control["asyncMultiAddr"]="224.1.1.1;224.1.1.1"#multicast address.
    control["asyncUdpIF"]="127.0.0.1;127.0.0.1"#interface to bind to.
