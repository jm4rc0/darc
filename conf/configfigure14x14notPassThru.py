...
control={
    ...
    "actMax":numpy.ones((actMapping.shape[0],),numpy.uint16)*65535,#4095,#max actuator value
    "actMin":numpy.zeros((actMapping.shape[0],),numpy.uint16),#4095,#max actuator value
...
#    "correlationPSF":correlationPSF,
    ...
    "useBrightest":0,
    "figureGain":2.0,
    "figureMultiplier":numpy.ones((nacts,),"f"),
    "figureAdder":numpy.ones((nacts,),"f")*(-32768),
