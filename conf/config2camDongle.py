...
subapFlag=numpy.concatenate([tel.Pupil(7*16,7*8,8,7).subflag.astype("i").ravel()]*2)#numpy.ones((nsubaps,),"i")
...
cameraParams=numpy.zeros((7*ncam+7,),numpy.int32)
cameraParams[0]=1#threadAffinElSize
cameraParams[1:15:7]=128*8#blocksize
cameraParams[2:15:7]=1000#timeout/ms
cameraParams[3:15:7]=[0,1]#port
cameraParams[4:15:7]=1#thread priority
cameraParams[5:15:7]=0#reorder
cameraParams[6:15:7]=0#testLastPixel
cameraParams[7:15:7]=0xffff#thread affinity
cameraParams[15]=0#resync
cameraParams[16]=1#wpu corrction
cameraParams[17]=2#nframes to skip
cameraParams[18]=0#pxlRowStartSkipThreshold
cameraParams[19]=0#pxlRowEndInsertThreshold
cameraParams[20]=0#record timestamp.
