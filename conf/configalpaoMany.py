...
slopeParams=None
mirrorParams=numpy.zeros((4+3*ndm,),"i")
mirrorParams[0]=1#affin el size
mirrorParams[1]=1#prio
mirrorParams[2]=-1#thread affinity
mirrorParams[3]=ndm
mirrorParams[4:4+ndm]=241
mirrorParams[5]=241
for i in range(ndm):
    mirrorParams[4+ndm:6+ndm]=numpy.fromstring("BEL11%d\0\0"%(i+1),dtype="i")#serial number of the mirror.  Need to export ACECFG to point to the directory holding the ALPAO config files.
...
control={
    ...
    "mirrorName":"libmirrorAlpaoMany.so",
