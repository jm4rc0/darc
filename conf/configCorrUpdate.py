...
#Investingating automatic correlation update.  Set corrUpdateGain to turn on (between 0->1).  Also, consider corrUpdateToCoG (defaults to 1)
import FITS
import tel
import numpy
import os
...
fname="/home/ali/git/darc/test/imglgs3x128x128.fits"
...
control={
    ...
    "delay":1000000,#will usually be zero (except if you want to set your own frame rate, e.g. if loading images from a file)
    "clearErrors":0,
    "camerasOpen":1,
    ...
    "maxAdapOffset":10,
    "noPrePostThread":0,
    "corrFFTPattern":corrFFTPattern,
    "corrClip":corrClip,
    "corrNStore":corrNStore,
    "corrNpxlCum":corrNpxlCum,
    "corrNpxlx":corrNpxlx,
    "corrSubapLoc":corrSubapLoc,
    "corrThresh":corrThresh,
    "corrThreshType":corrThreshType,
    "corrUpdateGain":corrUpdateGain,
