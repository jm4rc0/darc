...
control={
    ...
    #"E":1e-1*numpy.random.normal(0.,1.,(nacts,nacts)).astype("f"),#E from the tomoalgo in openloop.
    "E":1e-9*numpy.random.normal(0.,1.,(subapFlag.sum()*2,nacts)).astype("f"),#E from the tomoalgo in openloop.
    "threadAffinity":None,
