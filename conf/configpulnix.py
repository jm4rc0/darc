...
control={
    ...
    #"cameraParams":None,
    #"cameraName":"andorpci",
    "cameraName":"pulnix",#"sl240Int32cam",#"camfile",
    ...
    "figureParams":numpy.array([50,0,0xffff,1]).astype("i"),#timeout,port,affinity,priority
