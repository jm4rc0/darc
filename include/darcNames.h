...
char *paramNames;
paramNames=malloc(16*NBUFFERVARIABLES);
...
strncpy(&paramNames[USERACTS*16],"actuators",16);
...
strncpy(&paramNames[ADDUSERACTS*16],"addActuators",16);
strncpy(&paramNames[USERACTSEQ*16],"actSequence",16);
...
strncpy(&paramNames[CENTOPEN*16],"centOpen",16);
strncpy(&paramNames[CENTFRAMING*16],"centFraming",16);
strncpy(&paramNames[CENTPARAMS*16],"centParams",16);
strncpy(&paramNames[CENTNAME*16],"centName",16);
strncpy(&paramNames[USERACTSMASK*16],"actuatorMask",16);
...
strncpy(&paramNames[ADAPTIVEGROUP*16],"adaptiveWinGroup",16);
return paramNames;
}
#ifdef DONOTDEFINEME
" """
