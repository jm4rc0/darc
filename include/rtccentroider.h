...
int centOpen(char *name,int n,int *args,paramBuf *pbuf,circBuf *rtcErrorBuf,char *prefix,arrayStruct *arr,void **centHandle,int ncam,int *ncents,int* frameno);

/**
   Called when parameters have changed
*/
int centNewParam(void *centHandle,paramBuf *pbuf,unsigned int frameno,arrayStruct *arr);
/**
